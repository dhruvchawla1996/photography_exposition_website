		  ...
		  try{
		   List<FileItem>  items = upload.parseRequest(new ServletRequestContext(request));
			   for(FileItem item:items)
			   {
			    ...
			    File uploadDir = new File("/Users/dhruvchawla/Documents/workspace/JavaProject01/Project/WebContent/img/profile_pictures");
			    ...
			    String path =str.substring(index+1,len);
					 ...
					 int x = st.executeUpdate("UPDATE user_details SET pic_location='"+path+"' where user_id='"+session.getAttribute("user_id")+"'");
					 if(x>0)
					 {
